...
<!-- Docter/patient-profile.php  30 Nov 2019 04:12:09 GMT -->
<head>
		<meta charset="utf-8">
		<title>Doctor</title>
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								...
								<ul class="submenu">
									...
									<li><a href="doctor/doctor-register.php">Doctor Register</a></li>
								</ul>
							</li>	
							<li class="has-submenu">
								...
								<ul class="submenu">
									...
									<li><a href="doctor/doctor-profile.php">Doctor Profile</a></li>
					...
					<ul class="nav header-navbar-rht">
						...
						<li class="nav-item dropdown has-arrow logged-item">
							...
							<div class="dropdown-menu dropdown-menu-right">
								...
								<a class="dropdown-item" href="doctor/doctor-dashboard.php">Dashboard</a>
								<a class="dropdown-item" href="doctor/doctor-profile-settings.php">Profile Settings</a>
										...
										<div class="profile-info-widget">
											...
											<div class="profile-det-info">
												...
												<div class="patient-details">
													...
													<h5 class="mb-0"><i class="fas fa-map-marker-alt"></i> , United States</h5>
												</div>
											</div>
										</div>
									</div>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Name <span>Dental</span></a>
																		</h2>
																	</td>
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Ruby Perrin <span>Dental</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Deborah Angel <span>Cardiology</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Sofia Brient <span>Urology</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Marvin Campbell <span>Dental</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Katharine Berthold <span>Orthopaedics</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Linda Tobin <span>Neurology</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Paul Richard <span>Dermatology</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. John Gibbs <span>Dental</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Olga Barlow <span>Dental</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Marvin Campbell <span>Ophthalmology</span></a>
																		</h2>
																	</td>
																	<td class="text-right">
																		<div class="table-action">
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Ruby Perrin <span>Dental</span></a>
																		</h2>
																	</td>
																	<td>RS 450</td>
																	<td>14 Nov 2019</td>
																...
																<tr>
																	...
																	<td>
																		<h2 class="table-avatar">
																			...
																			<a href="doctor/doctor-profile.php">Dr. Olga Barlow <span>#0010</span></a>
																		</h2>
																	</td>
																	<td>RS 550</td>
																	<td>5 Nov 2019</td>
							...
							<div class="col-lg-3 col-md-6">
								...
								<div class="footer-widget footer-about">
									...
									<div class="footer-about-content">
										<p>type dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
...
<!-- Docter/patient-profile.php  30 Nov 2019 04:12:13 GMT -->
</html>